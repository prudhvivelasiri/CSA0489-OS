...
int main() {
    ...
    // Traverse the disk requests in the specified direction until reaching the end
    ...
    totalHeadMovement += abs(initialPosition - (direction == RIGHT ? 0 : 199));
    initialPosition = (direction == RIGHT ? 0 : 199);

    // Traverse the disk requests from the opposite end to the initial head position
